...
// const Footer = () => {
//   return (
//     <footer className="bg-gray-100 px-32 py-10">
...
//           <h3 className="font-semibold mb-2  md:text-left">Newsletter</h3>
...
//           </form>
//         </div>
//         <div className="w-full md:w-1/3 mb-4 md:mb-0  md:text-right">
//           <p className="text-gray-600 font-semibold md:mr-5 mb-2">Follow Me</p>
